...
if __name__ == "__main__":
    ...
    NODE3_IPV4 = os.getenv("NODE3_IPV4") # próximo nó no anel
    CONNECTION_PORT = int(os.getenv("CONNECTION_PORT"))

    process = Process(2, False, False) # inicializa processo com token (nó inicial)
    ...
    if(process.getStart() == True):
        ...
        clientThread = threading.Thread(target=process.sendMessage, args=(NODE3_IPV4,8003))
        clientThread.start()
