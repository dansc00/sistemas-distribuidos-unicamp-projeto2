...
class Process:
    ...
    def startServer(self, HOST, PORT, DATA_PAYLOAD):
        ...
        print("Opening server connection failed")
...
if __name__ == "__main__":
    ...
    serverThread = buildServerThread(HOST, CONNECTION_PORT, 1024, process2)
    clientThread = buildClientThread(1, NODE1_IPV4, 8001, 1024, process2)
