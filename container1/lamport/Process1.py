import random
import MessageHandler1 as messageHandler
...
class Process:
    ...
    def sendMessageForProcess2(self):

        SERVER_HOST = '172.18.0.5' # host do servidor proxy
        TARGET_HOST = '172.18.0.3' # host do servidor do processo alvo
        ...
        message = {'senderID': self.id, 'receiverID': 2, 'lamportClock': self.lamportClock, 'TARGET_HOST': TARGET_HOST} 
...
process1 = Process(0, 0, 0, 1)
process1.simulatesProcessExecution()
process1.sendMessageForProcess2()